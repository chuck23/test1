...
Fenetre.title("Mon programme en Tkinter") # Donne un titre à la fenêtre (par défaut c'est Tk)
...
zone_dessin.create_line(0,0,499,499,fill='red',width=4) # Dessine une ligne
zone_dessin.create_line(0,499,499,0,fill='red',width=4) # Dessine une ligne
